...
def baner():
	os.system("clear")
	print ("%s+───────────────────────────────────────────+"%(putih))
	print ("%s[%s~%s] %sAuthor  %s: %sRIDWAN-XD"%(hijau,cyan,hijau,putih,merah,hijau))
	print ("%s+───────────────────────────────────────────+"%(putih))
	print()
	print()
...
#  sp("\033[1;96m       ║║   ║╔═╗║║╔═╗║╚╣─╝║║╚╗║║          ")
#  sp("\033[1;96m       ║║   ║║ ║║║║ ╚╝ ║║ ║╔╗╚╝║          ")
#  sp("\033[1;96m       ║║ ╔╗║║ ║║║║╔═╗ ║║ ║║╚╗║║ \033[1;97mBY MR.1557")
#  sp("\033[1;96m       ║╚═╝║║╚═╝║║╚╩═║╔╣─╗║║ ║║║")
#  sp("\033[1;96m       ╚═══╝╚═══╝╚═══╝╚══╝╚╝ ╚═╝")
#  print()
...
note = "# Decypt lambda by ridwan\n# HELO BANH"
def ban(): # Program Bann
    os.system("clear")
    print(cyan+" JOIN GRUP AING HERA")
    time.sleep(2)
    os.system("xdg-open /https://chat.whatsapp.com/GdfaWDQp4PMAeJS9hGYXB1")
    time.sleep(4)
def menu():
    print()
